    ...
    <main className="min-h-screen bg-[#08090b] text-zinc-100">
      <header className="border-b border-white/10 bg-black/20">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-4 sm:px-10">
          ...
          <div className="flex items-center gap-3 text-xs"><Link href="/demo" className="rounded-full border border-white/10 px-3 py-1 text-zinc-300">Guided Demo</Link><span className="rounded-full border border-violet-300/20 bg-violet-300/10 px-3 py-1 text-violet-200">Security Lab</span><span className="text-zinc-500">No real checkout</span></div>
        </div>
      </header>

      <div className="mx-auto max-w-7xl px-6 py-10 sm:px-10">
        <section className="mb-10 grid gap-7 border-b border-white/10 pb-10 lg:grid-cols-[1fr_auto] lg:items-end">
          <div><p className="font-mono text-xs uppercase tracking-[0.22em] text-zinc-500">Security Lab · {shoppingTrapScenario.merchantName}</p><h1 className="mt-4 max-w-3xl text-4xl font-semibold tracking-[-0.04em] sm:text-6xl">A safe-looking store with unsafe defaults.</h1><p className="mt-5 max-w-2xl text-base leading-7 text-zinc-400">Inspect every Phase 1–7 contract, proposal, decision, controlled execution, recovery, and audit artifact with detailed manual controls.</p></div>
